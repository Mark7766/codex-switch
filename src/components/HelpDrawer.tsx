...
type Tab = 'faq' | 'onboarding' | 'diag' | 'report';

const PAGE_TIP: Record<Page, string> = {
  setup: '当前在首次设置：填好 API Key、选好模型，点「完成并应用配置」。',
  settings: '当前在设置：管理各供应商的 Key，以及 Codex / Claude 的接入与模型。',
  dashboard: '当前在工具接入状态：看四个工具是否已安装、配置是否已写入。',
};
